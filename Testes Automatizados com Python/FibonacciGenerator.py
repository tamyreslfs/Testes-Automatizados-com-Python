class FibonacciGenerator:
    def generate_sequence(self, n):
        ...
        sequence = [0, 1]
        for _ in range(n):  
            next_number = sequence[-1] + sequence[-2] # Corrigido BUG: Deve ser sequence[-1] + sequence[-2].
    ...
    def get_nth_number(self, n):
        ...
        a, b = 0, 1
        for _ in range(n - 2):  # Corrigido BUG: Deve ser range(n - 1).
            a, b = b, a + b  # Correção Atualiza 'a' e 'b' para os próximos números.
        return b
